...
parser.add_argument('--resume', type=str, default='', help='resume from save model')
...
parser.add_argument('--test_list', type=str, required=True, help='train list')
...
parser.add_argument('--cuda_index', type=str, default='0', help='cuda index')
