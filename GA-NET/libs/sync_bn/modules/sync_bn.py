...
class SyncBatchNorm(_BatchNorm):
    ...
    Please see the design idea in the 'notes <./notes/syncbn.htm>'_.
    ...
    ----------
        num_features: num_features from an expected input of
            size batch_size x num_features x height x with
    ...
    ---------
        .. [1] Ioffe, Sergey, and Christian Szegedy.
         "Batch normalization: Accelerating deep network training by reducing internal convariate shift." *ICML 2015*
        .. [2] Hang Zhang, Kristin Dana, Jianping Shi, Zhongyue Zhang, Xiaogang Wang, Ambrish Tyagi, and Amit Agrawal.
...
class BatchNorm1d(SyncBatchNorm):
    r"""
    .. warning:
        BatchNorm1d is deprecated in faver of :class:'encoding.nn.SyncBatchNorm'.
    """
...
class BatchNorm2d(SyncBatchNorm):
    r"""
    .. warning:
        BatchNorm2d is deprecated in faver of :class:'encoding.nn.SyncBatchNorm'.
    """
