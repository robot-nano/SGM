...
#ifndef GANET_SYNC_BN_SRC_GPU_COMMON_H_
#define GANET_SYNC_BN_SRC_GPU_COMMON_H_
...
struct Float2 {
  ...
  __device__ Float2(DType v1, DType v2)
      : v1(ScalarConvert<DType, Acctype>::to(v1)), v2(ScalarConvert<DType, Acctype>::to(v2)) {}
  __device__ Float2(DType v)
      : v1(ScalarConvert<DType, Acctype>::to(v)), v2(ScalarConvert<DType, Acctype>::to(v)) {}
...
#endif //GANET_SYNC_BN_SRC_GPU_COMMON_H_
